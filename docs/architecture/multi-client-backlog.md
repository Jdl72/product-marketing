...
Track the cross-cutting work required to make the Product Marketing repo reusable across clients while supporting a real Xnurta implementation.
...
## Epic: Reference Client Implementation - Xnurta
...
Implement Xnurta as the first full client workspace that consumes the reusable PMM system.

Child issues:

- `#78` Create Xnurta client workspace structure
- `#79` Create Xnurta client profile and segment taxonomy
- `#80` Create Xnurta funnel-stage map and coding rules
- `#81` Create Xnurta competitor map and alternative categories
- `#82` Create Xnurta strategic questions and scorecard
- `#83` Organize Xnurta evidence inventories
- `#84` Organize Xnurta record indexes
- `#85` Organize Xnurta synthesis indexes
- `#86` Organize Xnurta brief indexes and outputs
- `#87` Add Xnurta decision and cross-functional action trackers
...
- Xnurta is a reference client, not a permanent exception to the core method.
