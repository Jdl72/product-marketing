...
The goal is to keep the repo reusable across consulting clients while still allowing deep, evidence-rich work for a specific company such as Xnurta.
...
- Xnurta-specific terms such as `DSP`, `AMC`, or `Walmart`
